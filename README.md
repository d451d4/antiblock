...
Обход Интернет-цензуры стандартными средствами (SSH-туннелирование)
  ...
  * [Коротко об SSH-туннелировании](#-----------ssh---------------)
  * [Подготовка клиента (локального компьютера)](#------------------------------------------)
    + [Windows: установка OpenSSH клиента](#windows------------openssh--------)
    + [Windows: генерация RSA-ключей](#windows------------rsa-------)
    + [MacOS и Linux: генерация RSA-ключей](#macos---linux------------rsa-------)
    + [Использование полученного открытого SSH-ключа](#------------------------------------ssh------)
  * [Запуск виртуальной машины](#-------------------------)
    + [Digital Ocean](#digital-ocean)
  * [Подключение по SSH](#---------------ssh)
  ...
  * [Использование SSH-туннеля в качестве SOCKS прокси](#--------------ssh--------------------socks-------)
  * [Использование прокси-сервера Squid через SSH-туннель](#-----------------------------squid-------ssh--------)
